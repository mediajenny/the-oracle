...
/**
 * Parse an Excel file and return the data from the specified sheet (browser-safe)
 */
...
/**
 * Parse Excel file with header on row 2 (index 1) - browser-safe
 */
...
/**
 * Parse a file (CSV or Excel) automatically detecting format - browser-safe
 */
